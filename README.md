...
- `plw_teamexec`: (Testing) Allows members of g_teamID to execute RCON commands from chat  
...
Moving plugin file locations to be less invasive (verify linux installer)  
